        ...
        <el-row>
          <el-col :span="10">
            <el-form-item label="密码" prop="password">
              <el-input v-model="postForm.password" type="password" clearable />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="10">
            <el-form-item label="确认密码" prop="repassword">
              <el-input v-model="postForm.repassword" type="password" clearable />
            </el-form-item>
          </el-col>
        </el-row>
        <el-form-item label="状态">
          <el-switch v-model="postForm.status" :on-value="true" :off-value="false" />
        </el-form-item>
        <el-form-item label="授权">
          <el-checkbox v-model="postForm.checkAll" :indeterminate="postForm.isIndeterminate" @change="handleCheckAllChange">全选</el-checkbox>
